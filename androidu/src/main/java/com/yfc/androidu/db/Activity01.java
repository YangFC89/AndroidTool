...
public class Activity01 extends Activity implements OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        iv_fnhui = findViewById(R.id.iv_fanhui);
        iv_fnhui.setOnClickListener(new OnClickListener() {
            @Override
        ...
        personList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 4) {
                    setResult(1, getIntent().putExtra("city", allCity_lists.get(position).getName()));
                    finish();
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation arg0) {
            Log.i("info", "city = " + arg0.getCity());
            Log.i("errorCode", String.valueOf(arg0.getLocType()));
            if (!isNeedFresh) {
                return;
            }
            isNeedFresh = false;
